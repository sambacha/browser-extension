  ...
  require.register('chai/lib/chai/core/assertions.js', (exports, module) => {
    ...
    module.exports = function (chai, _) {
      ...
      function an(type, msg) {
        ...
        const article = ~['a', 'e', 'i', 'o', 'u'].indexOf(type.charAt(0))
          ? 'an '
          : 'a ';
   ...
   */
      ...
      Assertion.addMethod('property', function (name, val, msg) {
        ...
        if (undefined !== val) {
          this.assert(
            val === value,
            `expected #{this} to have a ${descriptor}${_.inspect(
              name,
            )} of #{exp}, but got #{act}`,
            `expected #{this} to not have a ${descriptor}${_.inspect(
              name,
            )} of #{act}`,
            val,
            value,
      ...
      function assertThrows(constructor, errMsg, msg) {
        ...
        if (arguments.length === 0) {
          ...
          constructor &&
          (constructor instanceof RegExp || typeof constructor === 'string')
        ) {
          errMsg = constructor;
          constructor = null;
        ...
        try {
          ...
          // next, check message
          const message =
            _.type(err) === 'object' && 'message' in err
              ? err.message
              : `${err}`;
    ...
    module.exports = function (chai, util) {
      ...
      assert.operator = function (val, operator, val2, msg) {
        ...
        test.assert(
          ...
          `expected ${util.inspect(val)} to be ${operator} ${util.inspect(
            val2,
          )}`,
          `expected ${util.inspect(val)} to not be ${operator} ${util.inspect(
            val2,
          )}`,
        );
      };
